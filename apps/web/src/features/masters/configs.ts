...
export const MASTERS: MasterConfig[] = [
  ...
  },
  {
    ...
    description: 'Effective-dated ₹/kg used as the material-cost basis.',
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'procurementPct', label: 'Procurement %', type: 'number', required: true, step: '0.01' },
      { name: 'transportationRate', label: 'Transportation rate', type: 'number', required: true, step: '0.01' },
      {
        name: 'transportationUom',
        label: 'Transportation UOM',
        type: 'select',
        required: true,
        options: asOptions(TRANSPORT_UOMS),
        defaultValue: 'per_lot',
      },
      { name: 'storagePct', label: 'Storage %', type: 'number', required: true, step: '0.01' },
      ...effectiveDates,
    ],
  },
  {
    ...
    fields: [
      { name: 'name', label: 'Name', type: 'text', required: true },
      {
        ...
        type: 'select',
        required: true,
        options: asOptions(PROCESS_TYPES),
      },
      {
        name: 'costingMethod',
        ...
        type: 'select',
        required: true,
        options: asOptions(COSTING_METHODS),
      },
    ...
    fields: [
      {
        ...
        type: 'select',
        required: true,
        options: asOptions(QC_METHODS),
        defaultValue: 'PCT_OF_MFG',
      },
  ...
  },
  {
    ...
    title: 'Customer Rating → Margin Map',
...
export const MASTER_BY_KEY = Object.fromEntries(MASTERS.map((m) => [m.key, m]))
